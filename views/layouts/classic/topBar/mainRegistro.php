  ...
  <div class="modal-dialog modal-simple">
    <div class="modal-content page-aviso">
      ...
      <div class="modal-body page-aviso-body">
        ...
        <div class="page-aviso-table">
          <!-- <div class="page-aviso-table-head"></div> -->
          <div class="page-aviso-table-body">
            <div class="page-aviso-table-tr">
              <div class="page-aviso-table-td">
            ...
            <div class="page-aviso-table-tr">
              ...
              <div class="page-aviso-table-td">
                A petición de esta instancia para dar certeza de premios entregados y participantes de las promociones y concursos que realizamos como permisionarios.
              </div>
              <div class="page-aviso-table-td">
                Expedientes de ganadores de los sorteos con permisos otorgados por esta autoridad.
              </div>
              <div class="page-aviso-table-td">
                Presentar constancia de entrega de premios, así como pago de impuestos de los mismos.
              </div>
            </div>
          </div>
        </div>
