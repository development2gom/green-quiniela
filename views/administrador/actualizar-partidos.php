    ...
    ?>
        <div id='js-seleccion-<?= $partido->txt_token ?>' class="sec-ap-item js-partido-<?=$partido->id_partido?>">
            ...
            <div class="sec-ap-item-visita">
                <img class="js-seleccionar-equipo js-equipos" src= '<?=$equipo2->txt_url_imagen_equipo;?>' data-nombre='<?=$equipo2->txt_nombre_equipo?>' data-token ="<?=$partido->txt_token?>" data-equipo="<?=$partido->id_equipo2?>" >
